...
class ilkYardimBolumler {
    ...
    func getIlkYardimBolumler() -> [bolum] {
        ...
        let ilkYardimBolumler : [bolum] = [
            ...
            bolum(id: 3, bolumUrl: "https://www.youtube.com/embed/pEksX32cjDQ", bolumIsmi: "İnsan Vücudu", bolumAciklama: "Bu Sayfa Temel Yaşam Desteği, Solunum Ve Kapl Durması Sayfasıdır."),
